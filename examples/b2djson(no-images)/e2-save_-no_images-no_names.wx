...
Class Box2DgfxTest Extends Window
	...
	Method OnRender( canvas:Canvas ) Override
		...
		If Keyboard.KeyPressed(Key.Space)
		 ...
		 'The Mouse joint (using the custom SimpleAABBQueryCallback included in box2d.monkey2)
		 If Mouse.ButtonPressed(MouseButton.Left)
			 
 			Local d:=New b2Vec2(0.001,0.001)
			Local aabb:b2AABB
			Local callback:SimpleAABBQueryCallback
			...
			callback=New SimpleAABBQueryCallback(mousePhysicsLocation)
